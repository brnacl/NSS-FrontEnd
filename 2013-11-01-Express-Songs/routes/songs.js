...
exports.index = function(req, res){
  Song.find(function(err, songs){
    res.render('songs/index', {title: 'All Songs', songs: songs, heading: 'Songs'});
  });
};
...
exports.show = function(req, res){
  Song.findById(req.params.id).populate('genres').exec(function(err, song){
    res.render('songs/show', {title: 'Show Song', song: song, heading: 'Song Details'});
  });
};
...
exports.new = function(req, res){
  Genre.find(function(err, genres){
    res.render('songs/new', {title: 'New Song', song: new Song(), genres: genres, _: _, heading: 'New Song'});
  });
};
...
exports.edit = function(req, res){
  Song.findById(req.params.id).populate('genres').exec(function(songErr, song){
    Genre.find(function(genreErr, genres){
      res.render('songs/edit', {title: 'Edit Song', song: song, genres: genres, _: _, heading: 'Edit Song'});
    });
  });
};
